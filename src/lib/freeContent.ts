/**
 * Complete list of all iRacing cars, grouped by category.
 * Used to populate the full car selection in the preferences modal.
 */
export const ALL_IRACING_CARS: string[] = [
  // NASCAR
...
/**
 * Complete list of all iRacing tracks.
 * Used to populate the full track selection in the preferences modal.
 */
export const ALL_IRACING_TRACKS: string[] = [
...
export const FREE_TRACKS = [
  ...
  // Rallycross / Special
  "Daytona Rallycross and Dirt Road", // only rallycross/dirt road configs included
];

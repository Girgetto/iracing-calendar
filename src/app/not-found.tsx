...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-900 light-theme:bg-white text-white light-theme:text-gray-900 px-4 transition-colors duration-300">
      <div className="text-center">
        ...
        <p className="text-sm text-slate-400 light-theme:text-gray-600 mb-8 transition-colors duration-300">
